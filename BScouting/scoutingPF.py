# hltGetConfiguration /dev/CMSSW_12_4_0/GRun --globaltag auto:phase1_2022_realistic --full --mc --type GRun --eras Run3 --process HLTX --unprescale --no-output --input root://cmsxrootd.fnal.gov//store/mc/Run3Winter22DR/TTToSemiLeptonic_TuneCP5_13p6TeV-powheg-pythia8/AODSIM/FlatPU0to70_122X_mcRun3_2021_realistic_v9-v2/70000/f05aecc5-10c7-48df-8399-22fac564b76d.root --max-events -1 --l1-emulator FullMC --l1 L1Menu_Collisions2022_v1_2_0_xml --paths HLTriggerFirstPath,DST_Run3_PFScoutingPixelTracking_v16,Dataset_ScoutingPFRun3,ScoutingPFOutput

# /dev/CMSSW_12_4_0/GRun/V188 (CMSSW_12_4_0)
...
process.hltDatasetScoutingPFRun3 = cms.EDFilter( "TriggerResultsFilter",
    ...
    throw = cms.bool( True ),
    triggerConditions = cms.vstring( 'DST_HLTMuon_Run3_PFScoutingPixelTracking_v18',
      'DST_Run3_PFScoutingPixelTracking_v18' )
)
...
process.schedule = cms.Schedule( *(process.HLTriggerFirstPath, process.ScoutingPFOutput, process.Dataset_ScoutingPFRun3, ))


# source module (EDM inputs)
process.source = cms.Source( "PoolSource",
    fileNames = cms.untracked.vstring(
        'root://cmsxrootd.fnal.gov//store/mc/Run3Winter22DR/TTToSemiLeptonic_TuneCP5_13p6TeV-powheg-pythia8/AODSIM/FlatPU0to70_122X_mcRun3_2021_realistic_v9-v2/70000/f05aecc5-10c7-48df-8399-22fac564b76d.root',
    ),
...
_customInfo['inputFile' ]=  ['root://cmsxrootd.fnal.gov//store/mc/Run3Winter22DR/TTToSemiLeptonic_TuneCP5_13p6TeV-powheg-pythia8/AODSIM/FlatPU0to70_122X_mcRun3_2021_realistic_v9-v2/70000/f05aecc5-10c7-48df-8399-22fac564b76d.root']
