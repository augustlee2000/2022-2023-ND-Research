...
file = ROOT.TFile("XtoAAto4b_X1000_A25.root","READ")
tree = file.Get("Events")

file1 = ROOT.TFile("XtoAAto4b_X1000_A30.root","READ")
tree1 = file1.Get("Events")

file2 = ROOT.TFile("XtoAAto4b_X1000_A50.root","READ")
tree2 = file2.Get("Events")

file3 = ROOT.TFile("XtoAAto4b_X1000_A70.root","READ")
tree3 = file3.Get("Events")

file4 = ROOT.TFile("XtoAAto4b_X1000_A80.root","READ")
tree4 = file4.Get("Events")

file5 = ROOT.TFile("XtoAAto4b_X1000_A100.root","READ")
tree5 = file5.Get("Events")

hists_legend = ROOT.TLegend(.65,.70,.90,.89)
hists_legend.Clear()
hists_legend.SetLineWidth(0)

colors=[ROOT.kBlue,ROOT.kRed, ROOT.kBlack, ROOT.kGreen, ROOT.kOrange,ROOT.kCyan]
names = ["XtoAAto4b_X1000_A25","XtoAAto4b_X1000_A30","XtoAAto4b_X1000_A50","XtoAAto4b_X1000_A70","XtoAAto4b_X1000_A80","XtoAAto4b_X1000_A100",]  

hist_array = MakeHist(6,colors,names,"XtoAAto4b_X1000_A100: Mass" ,"Mass (GeV)","Normalized Instances",2500,0,75)
legends(hist_array[0])
legends(hist_array[1])
legends(hist_array[2])
legends(hist_array[3]) 
legends(hist_array[4])
legends(hist_array[5]) 

btagging = 0.7527

getFilledHist(tree,hist_array[0],  btagging, Selection_dictionary['Mass'] )
getFilledHist(tree1,hist_array[1], btagging, Selection_dictionary['Mass'] )
getFilledHist(tree2,hist_array[2], btagging, Selection_dictionary['Mass'] )
getFilledHist(tree3,hist_array[3], btagging, Selection_dictionary['Mass'] )
getFilledHist(tree4,hist_array[4], btagging, Selection_dictionary['Mass'] )
getFilledHist(tree5,hist_array[5], btagging, Selection_dictionary['Mass'] )
...
HistNorm(hist_array[4])
HistNorm(hist_array[5])
