...
h1 = ROOT.TH1F("Di-Jet mass vs mass asymmetry", "XtoAAto4b_X3000_A50: Di-Jet mass vs mass asymmetry ", 100, 0, 2*pi)
                ...
                for y in range(rows):
                    ...
                    if ((a == c) or (a == d) or (b == c) or (b == d) or (c < a) ):
                        ...
                        if mass_asymmetry < min_mass_asymmetry:
                            ...
                            angle_placeholder = vec_final_1.DeltaR(vec_final_2)
                        
            h1.Fill(angle_placeholder)
