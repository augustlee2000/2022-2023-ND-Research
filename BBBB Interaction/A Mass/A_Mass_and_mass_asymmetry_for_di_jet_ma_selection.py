...
h1 = ROOT.TH2F("Di-Jet mass vs mass asymmetry", "XtoAAto4b_X1000_A100: Di-Jet mass vs mass asymmetry ", 200, 0, 200, 50, 0, 1)
...
file1 = ROOT.TFile("XtoAAto4b_X1000_A25.root","READ")
tree = file1.Get("Events")


h1 = ROOT.TH2F("Di-Jet mass vs mass asymmetry", "XtoAAto4b_X1000_A25: Di-Jet mass vs mass asymmetry ", 100, 0, 1000, 100, 0, 1)
            ...
            for x in range(rows):
                for y in range(rows):
                    ...
                    if ((a == c) or (a == d) or (b == c) or (b == d) or (c < a) ):
                        ...
                        if mass_asymmetry < min_mass_asymmetry:
                            
                            mass_asymmetry_placeholder = mass_asymmetry
                            min_mass_asymmetry = mass_asymmetry
                            
                            mass_1_placeholder = vec_final_1_mass
                            mass_2_placeholder = vec_final_2_mass
                        
            h1.Fill(mass_1_placeholder, mass_asymmetry_placeholder)
            h1.Fill(mass_2_placeholder, mass_asymmetry_placeholder)
